  ...
  bitcoin-cli -regtest -named createrawtransaction inputs="[{\"txid\":\"$raw_tx_decoded_txid\",\"vout\":0,\"sequence\":1},{\"txid\":\"$raw_tx_decoded_txid\",\"vout\":1,\"sequence\":1}]" outputs="{\"$recipient_address\":$btc_to_send,\"$change_address\":$btc_change}" locktime=0 replaceable=false version=22